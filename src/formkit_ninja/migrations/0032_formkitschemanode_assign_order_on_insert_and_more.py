    ...
    operations = [
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                ...
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    condition='WHEN (NEW."order" IS NULL)',
                    func='\n            NEW.order = (\n                SELECT COALESCE(MAX("order"), 0) + 1\n                FROM formkit_ninja_formkitschemanode\n                WHERE schema_id = NEW.schema_id\n            );\n            RETURN NEW;\n        ',
                    hash="6229f11cb59b4075b222ac375e0bd8843cae6c0b",
                    operation="INSERT",
                    pgid="pgtrigger_assign_order_on_insert_94ef5",
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                ...
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    condition='WHEN (NEW."order" IS NOT NULL)',
                    func='\n            UPDATE formkit_ninja_formkitschemanode\n            SET "order" = "order" + 1\n            WHERE schema_id = NEW.schema_id\n            AND "order" >= NEW."order"\n            AND id != NEW.id\n            AND pg_trigger_depth() = 1;\n            RETURN NEW;\n        ',
                    hash="f50d774de8b02bc398bc40b15263b89f3774c30e",
                    operation="INSERT OR UPDATE",
                    pgid="pgtrigger_increment_higher_orders_38803",
                    table="formkit_ninja_formkitschemanode",
                    when="AFTER",
                ),
            ),
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                ...
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    ...
                    hash="f78f8507727a65db410e5e5045c10be4f5e4698b",
                    operation="UPDATE",
