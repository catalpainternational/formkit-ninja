...
class TestTF611APICreation:
    ...
    def create_node(
        ...
        **kwargs,
        ...
        assert response.status_code == HTTPStatus.OK, f"Failed to create node '{name}': {response.content.decode()}"
    ...
    def link_node_to_schema(self, schema: models.FormKitSchema, node_id: UUID) -> models.FormComponents:
    ...
    def test_create_tf611_schema_via_api(self, admin_client: Client):
        ...
        print("✓ Linked root node to schema")
        ...
        print("  ✓ Created select field: women_priority")
        ...
        print("  ✓ Created number field: quantity")
        ...
        print("  ✓ Created dropdown field: unit")
        ...
        print("  ✓ Created select field: woman_priority")
        ...
        schema.to_pydantic()
        print("✓ Schema converts to Pydantic model successfully")
    ...
    def test_submit_tf611_data(self, admin_client: Client):
        ...
        assert separated_subs.count() == 3, f"Expected 3 SeparatedSubmissions, got {separated_subs.count()}"
