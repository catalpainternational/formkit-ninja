...
class Tf_6_1_1Meetinginformation(BaseModel):
...
class Tf_6_1_1Projectbeneficiaries(BaseModel):
...
class Tf_6_1_1ProjectoutputRepeaterprojectoutput(BaseModel):
    uuid: UUID | None = None


class Tf_6_1_1Projectoutput(BaseModel):
    repeaterProjectOutput: list[Tf_6_1_1ProjectoutputRepeaterprojectoutput] | None = None


class Tf_6_1_1(BaseModel):
